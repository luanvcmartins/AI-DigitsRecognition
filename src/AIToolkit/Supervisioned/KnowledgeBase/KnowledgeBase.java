...
public class KnowledgeBase<T> {
    ...
    public static class KnowlegededBaseBuilder<T> {
        ...
        /**
         * Set this to true if the first line of the file is the header and must be skipped.
         * 
        ...
        /**
         * Set the column index of where the class name of the data is. 
        ...
        /**
         * Build the Knowledged Base with the given confiiguration.
            ...
            while (line != null) {
                ...
                for (int columnId = 0; columnId < content.length; columnId++) {
                    if (columnId == exampleName) {
                        ...
                        System.out.println((T) content[columnId] instanceof String);
                    }
                }
